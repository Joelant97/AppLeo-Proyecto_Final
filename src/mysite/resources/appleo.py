...
tkinter.Label(window, text="María conoce un niño con muy mal carácter en su escuela", bg="green", fg="black",
...
# Crear un Button: 
tkinter.Button(window, text="Iniciar Prueba de Fluidez", bg="green", fg="black", font="none 12 bold",
               command=die).pack()
